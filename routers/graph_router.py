...
def add_location(location: Location, locations: graph_algos.Graph = 
                 Depends(dependencies.get_locations)):
    try:
...
def add_road(road: Road, locations: graph_algos.Graph = 
             Depends(dependencies.get_locations)):
...
def get_shortest_path(start: str, end: str, path_finder: graph_algos.PathFinder
